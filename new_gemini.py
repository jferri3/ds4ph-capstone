...
merged_data = None
grouped = None
total_species_abundance = None  # Declare total_species_abundance at the global level
...
setup_check = st.selectbox("Choose Analysis", ["None", "Transpose OTU File", "Transpose Metadata File", "Group SimpleIDs"])
